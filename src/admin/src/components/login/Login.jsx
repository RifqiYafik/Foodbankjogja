      ...
      <div className='bg-[#F8F8F8] flex flex-col justify-center'>
        <form className='max-w-[400px] w-full mx-auto'>
          ...
          <div className='flex flex-col py-2'>
            ...
            <input className='border border-black p-2 rounded-lg' type="password" />
          </div>
          <div className='flex justify-center'>
            <button onClick={() => {history ("")}} className='border w-1/2 my-5 py-2 bg-black text-white font-bold'>Log In</button>
          </div>
        </form>
      </div>
    </div>
